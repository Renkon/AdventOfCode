...
namespace AdventOfCode
{
    ...
    public class Tests
    {
        ...
        [TestMethod]
        [TestCategory(nameof(Problem15))]
        public void TestProblem15PartA()
        {
            Assert.AreEqual(458, new Problem15().DoPartA());
        }

        [TestMethod]
        [TestCategory(nameof(Problem15))]
        public void TestProblem15PartB()
        {
            Assert.AreEqual(2800, new Problem15().DoPartB());
        }

        [TestMethod]
        [TestCategory(nameof(Problem16))]
        public void TestProblem16PartA()
        {
            Assert.AreEqual(1012, new Problem16().DoPartA());
        }

        [TestMethod]
        [TestCategory(nameof(Problem16))]
        public void TestProblem16PartB()
        {
            Assert.AreEqual(2223947372407, new Problem16().DoPartB());
        }

        [TestMethod]
        [TestCategory(nameof(Problem17))]
        public void TestProblem17PartA()
        {
            Assert.AreEqual(12090, new Problem17().DoPartA());
        }

        [TestMethod]
        [TestCategory(nameof(Problem17))]
        public void TestProblem17PartB()
        {
            Assert.AreEqual(5059, new Problem17().DoPartB());
        }
    }
}
